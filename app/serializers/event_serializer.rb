class EventSerializer < ActiveModel::Serializer
  has_one    :user
  # has_many   :requests
  attributes :id, :date, :slots_on_offer, :is_expired, :is_at_capacity, :pending_requests, :accepted_requests, :rejected_requests, :number_of_pending_requests, :slots_remaining
