class UserSerializer < ActiveModel::Serializer
  has_many    :events
  # has_many    :requests
  attributes  :id, :email, :name, :is_bar, :band_telephone, :artist_id, :bar_location, :bar_telephone, :bar_size, :bar_image, :my_pending_requests, :my_accepted_requests, :my_rejected_requests, :num_of_pending_requests
